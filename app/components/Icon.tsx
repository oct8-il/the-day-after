/**
 * The failure icons, lifted from the prototype's ICONS map - plus `pulse`,
 * added when p4 became שירותי חירום and a chain link stopped describing it. They are
...
const PATHS: Record<string, React.ReactNode> = {
  ...
  pulse: (<><path d="M3 12h3.5l2-5.5 3.5 11 2.5-5.5H21" /></>),
